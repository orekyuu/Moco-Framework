...
mysql -uroot -ppassword moco_test -e "CREATE TABLE posts(id INT AUTO_INCREMENT PRIMARY KEY, title TEXT NOT NULL, contents TEXT NOT NULL, user_id INT NOT NULL) ENGINE = InnoDB;"
mysql -uroot -ppassword moco_sample -e "CREATE TABLE posts(id INT AUTO_INCREMENT PRIMARY KEY, title TEXT NOT NULL, contents TEXT NOT NULL, user_id INT NOT NULL) ENGINE = InnoDB;"
mysql -uroot -ppassword moco_develop -e "CREATE TABLE posts(id INT AUTO_INCREMENT PRIMARY KEY, title TEXT NOT NULL, contents TEXT NOT NULL, user_id INT NOT NULL) ENGINE = InnoDB;"
